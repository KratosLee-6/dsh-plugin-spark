...
| Import / 导入 | Reviewable SKILL.md parser with explicit contract editing / 可审阅 Markdown 解析与契约编辑 | Unsupported fields shown; no instruction execution; round-trip fixtures / 未知字段可见、不执行指令、往返样例通过 |
